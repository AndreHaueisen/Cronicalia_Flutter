  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: new Stack(children: [
        Image(
          image: NetworkImage(widget._book.remotePosterUri),
          alignment: Alignment.topCenter,
          fit: BoxFit.fill,
          color: _currentOrientation == Orientation.portrait ? null : const Color(0xBB000000),
          colorBlendMode: BlendMode.darken,
          width: MediaQuery.of(context).size.width,
          height: _coverPictureHeight,
        ),
        _buildBookInfoFront(context),
      ]),
    );
  }
